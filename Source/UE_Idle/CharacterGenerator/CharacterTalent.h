...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Character Talent")
    static void SetBalanceMultipliers(float BaseStatMultiplier, float ClubBonusMultiplier);
...
private:
    ...
    static float ClubBonusRangeMultiplier;  // 部活ボーナスの係数（1.0=100%, 0.375=37.5%）
};